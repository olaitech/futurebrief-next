...
export function ContactSectionNo() {
  return (
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div
          className="relative rounded-3xl border border-white/10 bg-gradient-to-br
                     from-gray-800/80 to-gray-900/90 p-12
                     backdrop-blur-2xl shadow-[0_0_60px_rgba(139,92,246,0.35)]"
        >
          {/* Heading */}
          ...
          <p className="mt-4 max-w-2xl text-white/70 text-lg">
            Ønsker du å samarbeide, gi tilbakemelding eller bare ta kontakt?  
            Du kan nå meg via en av kanalene nedenfor.
          </p>
