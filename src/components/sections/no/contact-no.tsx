        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 max-w-2xl text-white/70 text-lg">
              Ønsker du å samarbeide, gi tilbakemelding eller bare ta kontakt? Du kan nå meg via en av kanalene under.
            </p>
            ...
            <div className="mt-12 text-sm text-white/40">© 2026 Bygget av futurebrief.no</div>
          </div>
        </div>
      </div>
    </section>
